...
function doctorLoyout({children}) {
...
<nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gra-800 dark:border-gray-700">
  <div className="px-3 py-3 lg:px-5 lg:pl-3">
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start">
        ...
        <a onClick={()=>navigate('/doctor')}className="flex ml-2 md:mr-24">
  ...
  <div className="flex items-start justify-start relative">
    <h3 className="mr-4 text-xl text-gray-800 font-semibold">Welcome, Doctor</h3>
    <div className="relative">
      ...
      {isDropdownOpen && (
        <div className="absolute right-0 mt-2 w-40 bg-white border rounded-lg shadow-lg">
          <ul className="py-2">
            <li className="px-4 py-2 cursor-pointer hover:bg-gray-100">Edit Profile</li>
            <li className="px-4 py-2 cursor-pointer hover:bg-gray-100">Change Password</li>
            <li className="px-4 py-2 cursor-pointer hover:bg-gray-100"  onClick={()=>hadleLogout()} >Sign Out</li>
          </ul>
        </div>
      )}
    </div>
      ...
      <ul className="space-y-2 font-medium">
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span onClick={()=>navigate('/doctor')} className="ml-3">Profile</span>
            </a>
         </li>
         {/* <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
